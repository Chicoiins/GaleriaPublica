...
public class GalleryRepository {
    ...
    public List<ImageData> loadImageData(Integer limit, Integer offSet) throws FileNotFoundException {
        ...
        String[] projection = new String[] {
                MediaStore.Images.Media._ID, MediaStore.Images.Media.DISPLAY_NAME, MediaStore.Images.Media.DATE_ADDED, MediaStore.Images.Media.SIZE
        };
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.Q) {
            ...
            queryArgs.putInt(ContentResolver.QUERY_ARG_OFFSET, offSet); // Parei no passo 8.2
        }
    }
